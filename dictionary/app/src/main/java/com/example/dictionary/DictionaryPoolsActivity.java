...
import com.example.dictionary.threading.RetrieveRowsAsyncTask;
import com.example.dictionary.threading.RetrieveWordsAsyncTask;
import com.example.dictionary.threading.TaskDelegate;
import com.example.dictionary.threading.ThreadPoolRunnable;
...
public class DictionaryPoolsActivity extends AppCompatActivity implements
        ...
        Handler.Callback
{
    ...
    private void getTimeElapsed() {
        String time = String.valueOf(System.currentTimeMillis() - mStartTime);
        Log.d(TAG, "getTimeElapsed: TIME ELAPSED: " + time);
    }
}

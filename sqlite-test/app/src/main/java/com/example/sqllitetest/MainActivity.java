...
import com.example.sqllitetest.databinding.ActivityMainBinding;
...
//
//                Toast.makeText(this, "Nam = " + name + " phone = " + phone + " email = " + email, Toast.LENGTH_LONG).show();
                ...
                if(ContextCompat.checkSelfPermission(MainActivity.this, READ_CONTACTS) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (cursor != null) {
                        ...
                        while (cursor.moveToNext()) {
                            ...
                            contacts.add(cursor.getString(columnIndex));
                        }
                        cursor.close();
...
//            }
//        }
//        //                binding.fab.setEnabled(READ_CONTACTS_GRANTED);

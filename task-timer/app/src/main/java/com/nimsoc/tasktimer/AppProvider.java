...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.nimsoc.tasktimer.provider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        //  eg. content://com.nimsoc.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        // e.g. content://com.nimsoc.tasktimer.provider/Tasks/8
